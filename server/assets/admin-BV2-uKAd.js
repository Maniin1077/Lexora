...
import { u as useAuth, a as useNavigate, t as toast, A as AUTH_CHANGED_EVENT, M as MAX_ADMINS, g as getUserRole, L as Link, S as SYSTEM_ADMIN_EMAIL, b as getAllUsersForAdmin, c as AUTH_ACCOUNTS_KEY, d as AUTH_ADMIN_EMAILS_KEY } from "./router-BUJDySKP.js";
import { c as createLucideIcon, d as getHomeHeroContent, H as HOME_HERO_DEFAULTS, e as getNavigationLabels, N as NAV_LABEL_DEFAULTS, g as getContactDetails, C as CONTACT_DETAILS_DEFAULTS, a as SITE_CONTENT_CHANGED_EVENT, S as SiteLayout, f as NAV_LABEL_KEYS, h as PAGE_HERO_LABELS, i as PAGE_HERO_KEYS, j as getPageHeroContent, k as PAGE_HERO_DEFAULTS, b as SITE_CONTENT_KEY, s as setHomeHeroContent, r as resetHomeHeroContent, l as setNavigationLabels, m as resetNavigationLabels, n as setContactDetails, o as resetContactDetails, p as setPageHeroContent, q as resetPageHeroContent } from "./SiteLayout-fmTsCViQ.js";
import { A as APPLIED_CHANGED_EVENT, a as getApplicationSummary, b as APPLIED_KEY_PREFIX } from "./applications-CxYEjjqA.js";
import { C as CHANGE_LOG_CHANGED_EVENT, g as getVisibleChangeLogsForRole, a as CHANGE_LOG_KEY, l as logChange } from "./change-log-C_6h4jB_.js";
import { I as INTERNSHIPS_CHANGED_EVENT, g as getInternships, a as INTERNSHIPS_KEY } from "./internships-CpXYNrCW.js";
import { M as MAGAZINES_CHANGED_EVENT, g as getMagazines, a as MAGAZINES_KEY } from "./magazines-D21PTWll.js";
import { M as MEMBERS_CHANGED_EVENT, g as getMembers, a as MEMBERS_KEY } from "./members-D_f15q36.js";
import { U as Users } from "./users-XHeTQYC2.js";
import { S as ShieldCheck } from "./shield-check-D1pP0Hak.js";
import "node:events";
...
const BookUser = createLucideIcon("book-user", __iconNode$7);
const __iconNode$6 = [
