...
const BookOpenCheck = createLucideIcon("book-open-check", __iconNode$B);
const __iconNode$A = [
...
const BookUser = createLucideIcon("book-user", __iconNode$z);
const __iconNode$y = [
...
const BriefcaseBusiness = createLucideIcon("briefcase-business", __iconNode$y);
const __iconNode$x = [
