...
import { h as getPageHeroContent, a as SITE_CONTENT_CHANGED_EVENT, b as SITE_CONTENT_KEY } from "./SiteLayout-VfWkS54d.mjs";
function PageHero({
  eyebrow,
  title,
  subtitle,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-5xl px-6 py-16 text-center text-primary-foreground", children: [
