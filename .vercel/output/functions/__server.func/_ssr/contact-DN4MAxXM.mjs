...
import { g as getContactDetails, C as CONTACT_DETAILS_DEFAULTS, a as SITE_CONTENT_CHANGED_EVENT, S as SiteLayout, b as SITE_CONTENT_KEY } from "./SiteLayout-CBs5t8eG.mjs";
import { P as PageHero } from "./PageHero-B1stjOld.mjs";
import { u as useAuth } from "./router-9umsxH6a.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { M as Mail, L as Linkedin, I as Instagram } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-5xl px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `mailto:${contact.email}`, onClick: (e) => requireLoginForExternal(e, "email link"), className: "mt-3 block text-foreground/85 hover:text-accent", children: contact.email })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-7 w-7 text-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-4 font-display text-2xl text-primary", children: "Member Contacts" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-2 text-foreground/85", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${contact.secondaryEmail}`, className: "block hover:text-accent", children: [
              contact.secondaryEmailLabel,
              ": ",
              contact.secondaryEmail
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${contact.tertiaryEmail}`, className: "block hover:text-accent", children: [
