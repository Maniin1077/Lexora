...
import { u as useAuth } from "./router-CnQBulb0.mjs";
import { M as MEMBERS_CHANGED_EVENT, r as removeMember, g as getMembers, a as MEMBERS_KEY, u as updateMember, b as addMember } from "./members-22-QAKfc.mjs";
import { l as logChange } from "./change-log-CB2afnXF.mjs";
...
function MemberDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: (e) => e.stopPropagation(), className: "relative w-full max-w-lg rounded-2xl border border-border bg-card p-6 shadow-2xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "mt-5 space-y-3 text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-medium text-muted-foreground block mb-2", children: "Image *" }),
      ...
      form.image && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-background p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mb-2", children: "Preview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-32 w-32 overflow-hidden rounded-full ring-2 ring-gold/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: form.image, alt: "Member preview", className: "h-full w-full object-cover" }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-2 pt-4", children: [
