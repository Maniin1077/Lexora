...
import { c as getHomeHeroContent, H as HOME_HERO_DEFAULTS, d as getNavigationLabels, N as NAV_LABEL_DEFAULTS, g as getContactDetails, C as CONTACT_DETAILS_DEFAULTS, a as SITE_CONTENT_CHANGED_EVENT, S as SiteLayout, e as NAV_LABEL_KEYS, P as PAGE_HERO_LABELS, f as PAGE_HERO_KEYS, h as getPageHeroContent, b as SITE_CONTENT_KEY, i as createNotification, s as setHomeHeroContent, r as resetHomeHeroContent, j as setNavigationLabels, k as resetNavigationLabels, l as setContactDetails, m as resetContactDetails, n as setPageHeroContent, o as resetPageHeroContent, p as PAGE_HERO_DEFAULTS } from "./SiteLayout-CNsRNPbk.mjs";
import { u as useAuth, A as AUTH_CHANGED_EVENT, M as MAX_ADMINS, g as getUserRole, S as SYSTEM_ADMIN_EMAIL, a as getAllUsersForAdmin, b as AUTH_ACCOUNTS_KEY, c as AUTH_ADMIN_EMAILS_KEY } from "./router-DqURmC3W.mjs";
import { A as APPLIED_CHANGED_EVENT, a as getApplicationSummary, b as APPLIED_KEY_PREFIX } from "./applications-vtjmiLxT.mjs";
import { C as CHANGE_LOG_CHANGED_EVENT, g as getVisibleChangeLogsForRole, a as CHANGE_LOG_KEY, l as logChange } from "./change-log-ggNKkHy9.mjs";
import { I as INTERNSHIPS_CHANGED_EVENT, g as getInternships, a as INTERNSHIPS_KEY } from "./internships-D3vOHvd9.mjs";
import { M as MAGAZINES_CHANGED_EVENT, g as getMagazines, a as MAGAZINES_KEY } from "./magazines-0olCHHJq.mjs";
import { M as MEMBERS_CHANGED_EVENT, g as getMembers, a as MEMBERS_KEY } from "./members-DPSWOmeP.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { e as Users, S as ShieldCheck, B as BookUser, f as BriefcaseBusiness, N as Newspaper, g as BadgeCheck, h as Clock3, i as MessageSquareText, j as UserPlus, k as Sparkles, R as RefreshCcw } from "../_libs/lucide-react.mjs";
...
async function collectStats(role, adminCount, managedAdminCount) {
...
function AdminPage() {
  ...
  const [sendingMessage, setSendingMessage] = reactExports.useState(false);
  const [messageForm, setMessageForm] = reactExports.useState({
    targetEmail: "",
    title: "",
    message: ""
  });
  ...
  const submitImportantMessage = async (event) => {
    event.preventDefault();
  ...
  const updateHomeImageFromFile = (file) => {
    if (!file) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-accent", children: "Messaging" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 font-display text-2xl text-primary", children: "Send Important Message" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Send a notification to one registered user or leave the recipient blank to broadcast it to everyone." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquareText, { className: "h-8 w-8 text-accent" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submitImportantMessage, className: "mt-5 grid gap-4 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] uppercase tracking-wide text-muted-foreground", children: "Recipient Email" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", value: messageForm.targetEmail, onChange: (event) => setMessageForm((prev) => ({
            ...prev,
            targetEmail: event.target.value
          })), placeholder: "Leave blank to send to all users", className: "mt-1 w-full rounded-md border border-border bg-background px-3 py-2 text-sm outline-none focus:border-gold/70" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[11px] text-muted-foreground", children: "If empty, the message will appear for every signed-in user." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] uppercase tracking-wide text-muted-foreground", children: "Title" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: messageForm.title, onChange: (event) => setMessageForm((prev) => ({
            ...prev,
            title: event.target.value
          })), placeholder: "e.g. Profile update required", className: "mt-1 w-full rounded-md border border-border bg-background px-3 py-2 text-sm outline-none focus:border-gold/70" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-left lg:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] uppercase tracking-wide text-muted-foreground", children: "Message" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: messageForm.message, onChange: (event) => setMessageForm((prev) => ({
            ...prev,
            message: event.target.value
          })), rows: 4, placeholder: "Write an important update for users", className: "mt-1 w-full rounded-md border border-border bg-background px-3 py-2 text-sm outline-none focus:border-gold/70" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Messages are stored locally and shown with an unread dot in the header bell." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: sendingMessage, className: "inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 disabled:opacity-60", children: sendingMessage ? "Sending..." : "Send Message" })
        ] })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: saveHomeHero, className: "mt-6 rounded-xl border border-border bg-background p-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid gap-3 md:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-xs uppercase tracking-wide text-muted-foreground md:col-span-2", children: [
            "Hero image",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex cursor-pointer items-center gap-2 rounded-md border border-border px-3 py-2 text-xs font-medium text-foreground hover:bg-secondary mt-2", children: [
              "Choose image file",
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", accept: "image/*", className: "hidden", onChange: (event) => updateHomeImageFromFile(event.target.files?.[0] ?? null) })
            ] })
          ] }),
          homeForm.image && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 rounded-lg border border-border bg-background p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-2", children: "Preview" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-32 w-32 overflow-hidden rounded-lg ring-1 ring-gold/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: homeForm.image, alt: "Home hero preview", className: "h-full w-full object-cover" }) }) })
          ] })
        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 grid gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-xs uppercase tracking-wide text-muted-foreground", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: contactForm.secondaryEmailLabel, onChange: (event) => updateContactField("secondaryEmailLabel", event.target.value), className: "mt-1 w-full rounded-md border border-border bg-card px-3 py-2 text-sm text-foreground outline-none focus:border-gold/70" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-xs uppercase tracking-wide text-muted-foreground", children: [
                "Secondary email",
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: contactForm.secondaryEmail, onChange: (event) => updateContactField("secondaryEmail", event.target.value), className: "mt-1 w-full rounded-md border border-border bg-card px-3 py-2 text-sm text-foreground outline-none focus:border-gold/70" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-xs uppercase tracking-wide text-muted-foreground", children: [
                "Tertiary email name",
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: contactForm.tertiaryEmailLabel, onChange: (event) => updateContactField("tertiaryEmailLabel", event.target.value), className: "mt-1 w-full rounded-md border border-border bg-card px-3 py-2 text-sm text-foreground outline-none focus:border-gold/70" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-xs uppercase tracking-wide text-muted-foreground", children: [
                "Tertiary email",
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: contactForm.tertiaryEmail, onChange: (event) => updateContactField("tertiaryEmail", event.target.value), className: "mt-1 w-full rounded-md border border-border bg-card px-3 py-2 text-sm text-foreground outline-none focus:border-gold/70" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-xs uppercase tracking-wide text-muted-foreground", children: [
