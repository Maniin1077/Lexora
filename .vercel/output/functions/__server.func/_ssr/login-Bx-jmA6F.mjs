...
import { u as useAuth, s as supabase } from "./router-9umsxH6a.mjs";
...
function LoginPage() {
  ...
  const [signinCaptchaToken, setSigninCaptchaToken] = reactExports.useState(null);
  const [signupCaptchaToken, setSignupCaptchaToken] = reactExports.useState(null);
  ...
  const handlePasswordSignIn = async (event) => {
    ...
    if (!signinCaptchaToken) {
      toast.error("Please complete CAPTCHA before signing in.");
      return;
    }
    try {
      setBusy(true);
      await signInWithPassword(signInForm.email, signInForm.password, signinCaptchaToken);
  ...
  const handleCreateAccount = async (event) => {
    ...
    if (!signupCaptchaToken) {
      toast.error("Please complete CAPTCHA before creating account.");
      return;
    }
    try {
      setBusy(true);
      await register(createForm, signupCaptchaToken);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SiteLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto flex min-h-[70vh] w-full max-w-xl flex-col items-center justify-center px-6 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full rounded-2xl border border-gold/30 bg-card p-10 text-center", style: {
    ...
    !captchaConfigured && (mode === "signin" || mode === "create") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 rounded-md border border-amber-500/40 bg-amber-500/10 px-3 py-2 text-left text-xs text-amber-700 dark:text-amber-300", children: "CAPTCHA is not configured. Set VITE_RECAPTCHA_SITE_KEY to enable login and signup." }),
    mode === "signin" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handlePasswordSignIn, className: "mt-8 space-y-4 text-left", children: [
      ...
      captchaConfigured && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border border-border/80 bg-background/30 p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RecaptchaWrapper, { sitekey: recaptchaSiteKey, onChange: (token) => setSigninCaptchaToken(token) }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: busy || !captchaConfigured, className: "inline-flex w-full items-center justify-center rounded-md bg-primary px-5 py-3 text-sm font-medium text-primary-foreground transition hover:opacity-90 disabled:opacity-60", children: busy ? "Signing in..." : "Sign in" })
    ] }),
    mode === "create" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleCreateAccount, className: "mt-8 space-y-4 text-left", children: [
      ...
      captchaConfigured && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border border-border/80 bg-background/30 p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RecaptchaWrapper, { sitekey: recaptchaSiteKey, onChange: (token) => setSignupCaptchaToken(token) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: busy || !captchaConfigured, className: "inline-flex w-full items-center justify-center rounded-md bg-primary px-5 py-3 text-sm font-medium text-primary-foreground transition hover:opacity-90 disabled:opacity-60", children: busy ? "Creating account..." : "Create account" }),
