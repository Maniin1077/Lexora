...
import { S as SiteLayout } from "./SiteLayout-CBs5t8eG.mjs";
import { P as PageHero } from "./PageHero-B1stjOld.mjs";
import { u as useAuth } from "./router-9umsxH6a.mjs";
import { A as APPLIED_CHANGED_EVENT, g as getApplied, r as removeApplied } from "./applications-CxYEjjqA.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { M as Mail, S as ShieldCheck, C as Calendar, E as ExternalLink, T as Trash2 } from "../_libs/lucide-react.mjs";
...
function ProfilePage() {
  ...
  const [savingSecurity, setSavingSecurity] = reactExports.useState(false);
  ...
  const [securityForm, setSecurityForm] = reactExports.useState({
    newEmail: "",
    newPassword: ""
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-5xl px-6 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-gold/30 bg-card p-6 md:col-span-1", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSecuritySave, className: "mt-4 space-y-3 rounded-md border border-border/80 p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-left text-[11px] uppercase tracking-wide text-muted-foreground", children: "Account Security" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: securityForm.newEmail, onChange: (e) => setSecurityForm((prev) => ({
              ...prev,
              newEmail: e.target.value
            })), placeholder: "e.g. your@email.com", className: "mt-1 w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus:border-gold focus:outline-none" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[11px] text-muted-foreground", children: "Supabase will send verification links before changing your email." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "password", value: securityForm.newPassword, onChange: (e) => setSecurityForm((prev) => ({
              ...prev,
            ...
            securityForm.newPassword.length > 0 && securityForm.newPassword.length < 6 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[11px] text-destructive", children: "Password must be at least 6 characters." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: savingSecurity, className: "w-full rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-secondary disabled:opacity-60", children: savingSecurity ? "Updating..." : "Update Security" })
        ] }),
...
function AppliedOpportunityRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex flex-col gap-3 rounded-xl border border-border bg-card p-5 sm:flex-row sm:items-center sm:justify-between", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 items-center gap-2", children: [
      closed ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: true, className: "inline-flex items-center gap-1 rounded-md bg-muted px-3 py-2 text-xs font-medium text-muted-foreground", children: "Closed" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: item.link, target: "_blank", rel: "noreferrer", className: "inline-flex items-center gap-1 rounded-md border border-border px-3 py-2 text-xs font-medium hover:bg-secondary", children: [
        "Open ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3 w-3" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => removeApplied(userEmail, item.id), className: "inline-flex items-center gap-1 rounded-md border border-destructive/30 px-3 py-2 text-xs font-medium text-destructive hover:bg-destructive/10", "aria-label": "Remove from history", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-3 w-3" }) })
    ] })
  ] });
}
export {
