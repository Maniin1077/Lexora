...
import { i as isApplied, A as APPLIED_CHANGED_EVENT, m as markApplied } from "./applications-B8UoRCgz.mjs";
import { M as MAGAZINES_CHANGED_EVENT, s as subscribeMagazines, r as removeMagazine, g as getMagazines, a as MAGAZINES_KEY, u as updateMagazine, b as addMagazine } from "./magazines-C0NYYUeO.mjs";
...
function MagazinesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-6xl px-6 pb-20", children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 md:grid-cols-2", children: sorted.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(MagazineCard, { m, isAdmin, isLoggedIn: Boolean(user), isProfileComplete, userEmail: user?.email ?? null, onEdit: () => setEditingMagazine(m), onDelete: async () => {
